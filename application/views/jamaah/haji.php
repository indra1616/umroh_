	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-body table-responsive">
				...
				<?php $no=1; foreach( $query_haji->result() as $row ): ?>
					<tr>
						<td><?php echo $no++; ?></td>
						<td align="center">
						...
						<td>
							<a href="<?php echo base_url(); ?>welcome/daftar_periode/<?php echo $row->periode_id; ?>" class="btn btn-outline-success btn-sm">Daftar Sekarang</a>
						</td>
					</tr>
				<?php endforeach; ?>
				</table>
